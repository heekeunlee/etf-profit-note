            ...
            <div className="w-full max-w-md bg-white rounded-3xl overflow-hidden shadow-2xl relative" style={{ zIndex: 1 }}>
                ...
                <div className={`relative pt-6 pb-6 px-6 text-center sticky top-0 z-20 transition-all overflow-hidden duration-700 ${activeUser === 'heekeun' ? 'bg-white/90 backdrop-blur-md' : 'bg-white/90 backdrop-blur-md'} `}>
                    ...
                    <div className="relative z-10 mt-4 flex flex-col items-center gap-1 opacity-90">
                        <div className="text-base text-blue-600 font-medium bg-blue-50/80 px-4 py-2 rounded-xl w-full max-w-[300px] flex justify-between items-center border border-blue-100 mt-1 shadow-sm">
                            <span className="whitespace-nowrap">2026년 누적수익금</span>
                            <span className="font-bold text-blue-700 whitespace-nowrap">₩{data.total_profit.toLocaleString()}</span>
                        </div>
                    </div>
                </div>
